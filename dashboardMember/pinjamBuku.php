...
$queryNotif = "SELECT * FROM tb_pinjambuku WHERE email='$_SESSION[email]' ORDER BY created_at DESC ";
...
?>
    ...
    if ($td > $exp) {
        $id_user_date = $rowNotif['id'];

        $data_notif = $rowNotif['notif'];
        if ($data_notif == 3) {
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="proses/pinjamBuku.php" method="POST">
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nama</label>
                                            <input name="nama" type="text" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">NIP</label>
                                            <input name="nip" type="text" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Unit</label>
                                            <input name="unit" type="text" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nomor Telepon</label>
                                            <input name="no_telp" type="text" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Kode Buku</label>
                                            <input name="kode_buku" type="text" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input name="tahun_buku" type="text" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Tanggal Pinjam</label>
                                            <input name="tgl_pinjam" type="date" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Tanggal Kembali</label>
                                            <input name="tgl_kembali" type="date" autocomplete="off" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <input name="info" type="text" value="belum dikembalikan" hidden></input>
                                        <input name="notif" type="number" value=0 hidden></input>
