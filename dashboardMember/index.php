                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <h4 class="mt-1 mb-1">Selamat datang <?php echo $peg['nama']; ?> </h4>
                                        <p class="font-13"> TAMASERTA merupakan sistem informasi berbasis website yang digunakan untuk pencatatan tanda terima penyerahan sertifikat tanah secara digital. Dengan adanya pencatatan tanda terima penyerahan sertifikat tanah secara digital, diharapkan dapat meminimalisir hilangnya tanda terima penyerahan sertifikat tanah dan mempermudah dalam penemuan kembali informasi tanda terima penyerahan sertifikat tanah.</p>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end col -->
