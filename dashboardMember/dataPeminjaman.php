    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar="">
                ...
                <?php
                $query2 = "SELECT * FROM tb_user WHERE email='$_SESSION[email]'";
                                        ...
                                        <div class="table-responsive-sm">
                                                    ...
                                                    <div class="app-search dropdown">
                                                        <form>
                                                            <div class="input-group">
                                                                <form action="dataPeminjaman.php" method="GET">
                                                                    <input type="text" name="query" class="form-control dropdown-toggle" placeholder="Cari kode buku..." id="top-search">
                                            ...
                                            <table class="table table-centered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    if (isset($_GET['query'])) {
                                                        $cari = $_GET['query'];
                                                        $query = "SELECT * FROM tb_pinjambuku WHERE kode_buku LIKE '" . $cari . "' ";
                                                    } else {
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if ($row['info'] == 'belum dikembalikan') {
                                                                    echo ' <span class="badge badge-danger-lighten">Belum dikembalikan</span>';
                                                                } elseif ($row['info'] == 'sudah dikembalikan') {
                                                                    echo ' <span class="badge badge-success-lighten">Sudah dikembalikan</span>';
                                                                }
                                                                ?>

                                                            </td>
                                                            <td class="table-action" style="width: 120px;">
                                                                <a href="editPinjamBuku.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="proses/hapusPinjamBuku.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                                <a href="detailPeminjamanBuku.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class=" uil-clipboard-alt"></i></a>
                                                            </td>
                                                        </tr>
