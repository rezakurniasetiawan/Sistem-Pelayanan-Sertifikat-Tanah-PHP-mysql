                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="proses/editProfil.php" method="POST" enctype="multipart/form-data">
                                        <input name="id" value="<?php echo $data['id']; ?>" hidden />
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Unit</label>
                                            <input type="text" id="example-input-small" name="unit" value="<?php echo $data['unit']; ?>" class="form-control form-control-sm">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Edit Foto</label><br>
