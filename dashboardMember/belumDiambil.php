                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Data Sertifikat (Belum Diambil)</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            if ($peg['akses'] == 'Moderator') {
                                                             ...
                                                             <a href="editBelumDiambil.php?id=' . $row['id'] . '" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                             <a href="proses/hapusBelumDiambil.php?id=' . $row['id'] . '" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                             <a href="detailSertifikatBelum.php?id=' . $row['id'] . '" class="action-icon"> <i class=" uil-clipboard-alt"></i></a>
                                                         </td>';
                                                            }
                                                            ?>
