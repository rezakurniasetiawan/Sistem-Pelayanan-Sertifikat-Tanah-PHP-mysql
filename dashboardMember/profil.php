                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col">
                                                    <div>
                                                        ...
                                                        <p class="font-13 text-white-50"> <?php echo $peg['akses']; ?></p>
                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2">
                                                <label for="example-input-small" class="form-label">Akses</label>
                                                <input type="text" disabled id="example-input-small" name="unit" value="<?php echo $peg['akses']; ?>" class="form-control form-control-sm">
                                            </div>
                                            <div class="mb-2">
                                                <label for="example-input-small" class="form-label">Unit</label>
                                                <input type="text" disabled id="example-input-small" name="unit" value="<?php echo $peg['unit']; ?>" class="form-control form-control-sm">
                                            </div>
                                            <div class="mb-2">
                                                <label for="example-input-small" class="form-label">Nip</label>
                                                <input type="text" disabled id="example-input-small" name="unit" value="<?php echo $peg['nip']; ?>" class="form-control form-control-sm">
                                            </div>
                                            <br>
