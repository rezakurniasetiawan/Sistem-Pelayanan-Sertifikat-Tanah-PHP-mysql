                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="proses/cekRegister.php" method="POST">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input name="nama" class="form-control" type="text" id="fullname" placeholder="Enter your name" required>
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input name="nip" class="form-control" type="text" required placeholder="Enter your nip">
                                </div>

                                <div class="mb-2">
                                    <label for="emailaddress" class="form-label">Unit</label>
                                    <input name="unit" class="form-control" type="text" required placeholder="Enter your unit">
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input name="hakakses" value="member" type="checkbox" class="form-check-input" id="checkbox-signup">
