                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="proses/editPekerjaan.php" method="POST">
                                        <input name="id" value="<?php echo $data['id']; ?>" hidden />
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Pekerjaan</label>
                                            <input value="<?php echo $data['pekerjaan']; ?>" type="text" id="example-input-small" name="pekerjaan" class="form-control form-control-sm">
                                        </div>
