                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="table-action" style="width: 120px;">
                                                                <a href="editSudahDiambil.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="proses/hapusSudahDiambil.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                                <a href="detailSertifikatSudah.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class=" uil-clipboard-alt"></i></a>
                                                            </td>
                                                        </tr>
