                                ...
                                <div class="card-body">
                                    <form action="proses/tambahSertifikat.php" method="POST" enctype="multipart/form-data">
                                        <div class="mb-2">
                                            ...
                                            <input name="no_agenda" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nomor Hak</label>
                                            <input name="no_hak" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nama Pemegang Hak</label>
                                            <input name="n_pem_hak" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nomor Seri</label>
                                            <input name="no_seri" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input name="tgl_208" autocomplete="off" type="date" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nomor DI.301</label>
                                            <input name="no_301" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nomor Berkas</label>
                                            <input name="no_berkas" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Tahun Berkas</label>
                                            <input name="tahun_berkas" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Luas</label>
                                            <input name="luas" autocomplete="off" type="text" id="example-input-small" class="form-control form-control-sm" required>
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-select" class="form-label">Kecamatan/Desa</label>
                                            <input type="text" autocomplete="off" name="kelurahan" value="" id="kelurahan" class="form-control form-control-sm" required />
                                        </div>
                                        <div class="checkbox-card">
                                            ...
                                            <div class="passport-box">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <input name="foto" type="file" id="example-input-small" class="form-control form-control-sm">
                                                </div>
                                            </div>
                                        </div>
