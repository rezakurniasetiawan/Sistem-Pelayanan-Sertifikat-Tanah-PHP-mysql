                                        ...
                                        <div class="table-responsive-sm">
                                                    ...
                                                    <div class="app-search dropdown">
                                                        <form>
                                                            <div class="input-group">
                                                                <form action="belumDiambil.php" method="GET">
                                                                    <input type="text" name="query" class="form-control dropdown-toggle" autocomplete="off" placeholder="Cari nomor berkas..." id="top-search">
                                            ...
                                            <table class="table table-centered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $data = mysqli_query($koneksi, "select * from tb_sertifikat WHERE status_sertif='Belum diambil' ORDER BY created_at DESC");
                                                    $jumlah_data = mysqli_num_rows($data);
                                                    $total_halaman = ceil($jumlah_data / $batas);

                                                    if (isset($_GET['query'])) {
                                                        $cari = $_GET['query'];
                                                        $query = "SELECT * FROM tb_sertifikat WHERE no_berkas LIKE '%" . $cari . "%'  ";
                                                    } else {
                                                        $query = "SELECT * FROM tb_sertifikat WHERE status_sertif='Belum diambil' ORDER BY created_at DESC limit $halaman_awal, $batas";
                                                    }
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="table-action" style="width: 120px;">
                                                                <a href="editBelumDiambil.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="proses/hapusBelumDiambil.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                                <a href="detailSertifikatBelum.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class=" uil-clipboard-alt"></i></a>
                                                            </td>
                                                        </tr>
