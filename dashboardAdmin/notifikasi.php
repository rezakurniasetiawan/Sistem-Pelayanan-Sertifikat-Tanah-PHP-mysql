                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center mt-sm-0 mt-3 text-sm-end">
                                        <form action="proses/kembalikan.php" method="POST">
                                            <input type="hidden" name="id" value=" <?php echo $datadetail['id']; ?>">
                                            <input type="submit" value="Kembalikan Buku" class="btn btn-success">
                                            </input>
                                        </form>
                                    </div>
                                    <div class="mb-2">
                                        <label for="example-input-small" class="form-label">Nama</label>
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['nama']; ?></span>
                                    </div>
                                    <div class="mb-2">
                                        <label for="example-input-small" class="form-label">NIP</label>
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['nip']; ?></span>
                                    </div>
                                    <div class="mb-2">
                                        <label for="example-input-small" class="form-label">Unit</label>
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['unit']; ?></span>
                                    </div>
                                    <div class="mb-2">
                                        <label for="example-input-small" class="form-label">Nomor Telepon</label>
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['no_telp']; ?></span>
                                    </div>
                                    <div class="mb-2">
                                        <label for="example-input-small" class="form-label">Kode Buku</label>
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['kode_buku']; ?></span>
                                    </div>
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['tahun_buku']; ?></span>
                                    </div>
                                    <div class="mb-2">
                                        <label for="example-input-small" class="form-label">Tanggal Pinjam</label>
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['tgl_pinjam']; ?></span>
                                    </div>
                                    <div class="mb-2">
                                        <label for="example-input-small" class="form-label">Tanggal Kembali</label>
                                        <span type="text" class="form-control form-control-sm"><?php echo $datadetail['tgl_kembali']; ?></span>
                                    </div>
                                </div> <!-- end card-body -->
                            </div> <!-- end card -->
                        </div> <!-- end col -->
