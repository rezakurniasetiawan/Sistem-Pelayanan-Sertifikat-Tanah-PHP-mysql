                    ...
                    <ul class="list-unstyled topbar-menu float-end mb-0">
                        <!-- <li class="dropdown notification-list d-lg-none">
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg p-0">
                                <form action="dataUser.php" method="GET" class="p-3">
                                    <input type="submit" class="form-control" placeholder="Search ..." aria-label="Recipient's username">
                                </form>
                            </div>
                        </li> -->
                        ...
                        <form>
                            <div class="input-group">
                                <form action="dataUser.php" method="GET">
                                    <input type="text" name="query" class="form-control dropdown-toggle" placeholder="Cari nip user..." id="top-search">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="table-head-preview">
                                        <div class="table-responsive-sm">
                                            <div class="row mb-2">
                                                <div class="col-sm-7">
                                                    <a href="tambahUser.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Tambah User</a>
                                                </div>
                                                <div class="col-sm-5">
                                                    <div class="app-search dropdown">
                                                        <form>
                                                            <div class="input-group">
                                                                <form action="dataUser.php" method="GET">
                                                                    <input type="text" name="query" class="form-control dropdown-toggle" placeholder="Cari nama user..." id="top-search">
                                                                    <span class="mdi mdi-magnify search-icon"></span>
                                                                    <input type="submit" name="cari" value="Cari" class="input-group-text btn-primary"></input>
                                                                </form>
                                                            </div>
                                            ...
                                            <table class="table table-centered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $data = mysqli_query($koneksi, "select * from tb_user WHERE hakakses='member' ORDER BY created_at DESC");
                                                    $jumlah_data = mysqli_num_rows($data);
                                                    $total_halaman = ceil($jumlah_data / $batas);

                                                    if (isset($_GET['query'])) {
                                                        $cari = $_GET['query'];
                                                        $query = "SELECT * FROM tb_user WHERE nama LIKE '%" . $cari . "%' ";
                                                    } else {
                                                        $query = "SELECT * FROM tb_user WHERE hakakses='member' ORDER BY created_at DESC limit $halaman_awal, $batas";
                                                    }
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td> <?php echo $no ?></td>
                                                            <td>
                                                                <img src="../gambar/<?php echo $row['foto']; ?>" alt="user-image" class="rounded-circle" height="30">
                                                                <span>
                                                                    <?php echo $row['nama']; ?>
                                                                </span>
                                                            </td>
                                                            ...
                                                            <td class="table-action" style="width: 90px;">
                                                                <a href="editUser.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="proses/hapusUser.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            </td>
                                                        </tr>
