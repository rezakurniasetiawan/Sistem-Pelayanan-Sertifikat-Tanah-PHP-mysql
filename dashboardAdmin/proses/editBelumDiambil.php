...
if ($foto != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        if (!$result) {
            ...
            echo "<script>alert('Data berhasil diedit.');window.location='../belumDiambil.php';</script>";
        }
    } else {
        //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
        echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='../belumDiambil.php';</script>";
    }
} else {
