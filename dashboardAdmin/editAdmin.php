                                ...
                                <div class="card-body">
                                    <form action="proses/editAdmin.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input name="nama" value="<?php echo $data['nama']; ?>" type="text" id="example-input-small" class="form-control form-control-sm" placeholder="input your name">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Email</label>
                                            <input name="email" value="<?php echo $data['email']; ?>" type="text" id="example-input-small" class="form-control form-control-sm" placeholder="input your email">
                                        </div>
                                        <div class="mb-2">
                                            <input name="password" value="<?php echo $data['password']; ?>" type="password" id="example-input-small" class="form-control form-control-sm" placeholder="input your name" hidden>
                                        </div>
                                        ...
                                        <input name="unit" type="text" value="admin" hidden></input>
                                        <input name="hakakses" type="text" value="admin" hidden></input>
                                        <input name="akses" type="text" value="admin" hidden></input>
                                        <input name="nip" type="text" value="admin" hidden></input>
                                        <br>
