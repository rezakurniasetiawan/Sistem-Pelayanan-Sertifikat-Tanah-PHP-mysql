                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="table-head-preview">
                                        <div class="table-responsive-sm">
                                            <div class="row mb-2">
                                                <div class="col-sm-4">
                                                    <a href="tambahAdmin.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Tambah Pekerjaan</a>
                                                </div>
                                                <div class="col-sm-8">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="table-action" style="width: 90px;">
                                                                <a href="editPekerjaan.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="proses/hapusPekerjaan.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            </td>
                                                        </tr>
