                                    ...
                                    <div class="tab-pane show active" id="table-head-preview">
                                        <div class="table-responsive-sm">
                                            <div class="row mb-2">
                                                ...
                                                <!-- <div class="col-sm-4">
                                                    <a href="tambahAdmin.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Admin</a>
                                                </div> -->
                                                <!-- <div class="col-sm-6">
                                            ...
                                            <table class="table table-centered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $data = mysqli_query($koneksi, "select * from tb_sertifikat ORDER BY created_at DESC");
                                                    $jumlah_data = mysqli_num_rows($data);
                                                    $total_halaman = ceil($jumlah_data / $batas);

                                                    // jalankan query untuk menampilkan semua data diurutkan berdasarkan nim
                                                    $query = "SELECT * FROM tb_sertifikat ORDER BY created_at DESC limit $halaman_awal, $batas";
