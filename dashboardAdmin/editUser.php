                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center mt-sm-0 mt-3 text-sm-end">
                                        <a href="resetPassword.php?id=<?php echo $data['id']; ?>"">
                                                    <button type=" button" class="btn btn-success">
                                            <i class="mdi mdi-account-edit me-1"></i> Reset Passwors
                                            </button>
                                        </a>
                                    </div>
                                    <form action="proses/editUser.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input value="<?php echo $data['nama']; ?>" type="text" id="example-input-small" name="nama" class="form-control form-control-sm" placeholder="input your name">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Email</label>
                                            <input value="<?php echo $data['email']; ?>" type="text" id="example-input-small" name="email" class="form-control form-control-sm" placeholder="input your email">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Unit</label>
                                            <input value="<?php echo $data['unit']; ?>" type="text" id="example-input-small" name="unit" class="form-control form-control-sm" placeholder="input your unit">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Nip</label>
                                            <input value="<?php echo $data['nip']; ?>" type="text" id="example-input-small" name="nip" class="form-control form-control-sm" placeholder="input your nip">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-select" class="form-label">Access</label>
                                            <select name="akses" class="form-select" id="example-select">
                                        ...
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Change Foto</label><br>
                                            <img src="../gambar/<?php echo $data['foto']; ?>" alt="user-image" class="mb-2" height="200">
                                            <input type="file" id="example-input-small" name="foto" class="form-control form-control-sm" placeholder="input your nip">
                                        </div>
