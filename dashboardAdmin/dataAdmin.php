                                ...
                                <div class="tab-content">
                                    <div class="tab-pane show active" id="table-head-preview">
                                        <div class="table-responsive-sm">
                                            <div class="row mb-2">
                                                <div class="col-sm-7">
                                                    <a href="tambahAdmin.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Tambah Admin</a>
                                                </div>
                                                <div class="col-sm-5">
                                                    <div class="app-search dropdown">
                                                        <form>
                                                            <div class="input-group">
                                                                <form action="dataAdmin.php" method="GET">
                                                                    <input type="text" name="query" class="form-control dropdown-toggle" placeholder="Cari nama admin..." id="top-search">
                                                                    <span class="mdi mdi-magnify search-icon"></span>
                                            ...
                                            <table class="table table-centered mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $data = mysqli_query($koneksi, "select * from tb_user WHERE hakakses='admin' ORDER BY created_at DESC");
                                                    ...
                                                    if (isset($_GET['query'])) {
                                                        ...
                                                        $query = "SELECT * FROM tb_user WHERE hakakses='admin' ORDER BY created_at DESC limit $halaman_awal, $batas";
                                                    }
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="table-action" style="width: 90px;">
                                                                <a href="editAdmin.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-pencil"></i></a>
                                                                <a href="proses/hapusAdmin.php?id=<?php echo $row['id']; ?>" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            </td>
                                                        </tr>
