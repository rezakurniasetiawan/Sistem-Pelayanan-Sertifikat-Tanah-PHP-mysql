                                ...
                                <div style="max-height: 230px;" data-simplebar="">
                                    ...
                                    if (mysqli_num_rows($sqlget3) > 0) {
                                        while ($result2 = mysqli_fetch_assoc($sqlget3)) {
                                            ...
                                            <p class="notify-details">Kode buku : ' . $result2['kode_buku'] . '
                                ...
                                <div class="card-body p-0">
                                    <div class="row g-0">
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="card shadow-none m-0 border-start">
                                                <div class="card-body text-center">
                                                    <i class=" uil-user-square" style="font-size: 24px;"></i>
                                                    <h3><span> <?php echo $jumlah_usermember; ?></span></h3>
                                                    <p class="text-muted font-15 mb-0">Total Member</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="card shadow-none m-0 border-start">
                                                <div class="card-body text-center">
                                                    ...
                                                    <h3><span><?php echo $jumlah_moderator; ?></span></h3>
                                                    <p class="text-muted font-15 mb-0">Total Moderator</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="card shadow-none m-0 border-start">
                                                <div class="card-body text-center">
                                                    <i class=" uil-file-bookmark-alt" style="font-size: 24px;"></i>
                                                    <h3><span><?php echo $jumlah_sertifikat; ?></span></h3>
                                        ...
                                        <div class="col-sm-6 col-xl-3">
                                            <div class="card shadow-none m-0 border-start">
                                                <div class="card-body text-center">
                                                    <i class=" uil-book-open" style="font-size: 24px;"></i>
                                                    <h3><span><?php echo $jumlah_buku; ?></span></h3>
                                                    <p class="text-muted font-15 mb-0">Total Peminjaman</p>
                                                </div>
                                            </div>
                                        </div>
