                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <form action="proses/resetPassword.php" method="POST">
                                        <input name="id" value="<?php echo $data['id']; ?>" hidden />
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Password (Masukkan password baru)</label>
                                            <input type="text" autocomplete="off" id="example-input-small" name="password" class="form-control form-control-sm" required>
                                        </div>
                                        <br>
