                                ...
                                <div class="card-body">
                                    <form action="proses/tambahAdmin.php" method="POST">
                                        <div class="mb-2">
                                            ...
                                            <input name="nama" type="text" id="example-input-small" class="form-control form-control-sm" placeholder="input your name">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Email</label>
                                            <input name="email" type="text" id="example-input-small" class="form-control form-control-sm" placeholder="input your email">
                                        </div>
                                        <div class="mb-2">
                                            <label for="example-input-small" class="form-label">Password</label>
                                            <input name="password" type="password" id="example-input-small" class="form-control form-control-sm" placeholder="input your name">
                                        </div>
